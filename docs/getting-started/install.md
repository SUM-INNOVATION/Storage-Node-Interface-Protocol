...
> source. See [`PLATFORM-SUPPORT.md`](../compatibility/platform-support.md).
...
recipe in [`PLATFORM-SUPPORT.md`](../compatibility/platform-support.md). The short
version on Linux:
...
- `v0.4.x` does not ship code-signed binaries, notarized macOS
  ...
  [`PLATFORM-SUPPORT.md`](../compatibility/platform-support.md) "Not planned for
